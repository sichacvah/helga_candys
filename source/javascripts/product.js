...
Elm.Product.make = function (_elm) {
   ...
   function (v) {
      return Elm.Native.List.make(_elm).toArray(v).map(function (v) {
         return {id: v.id,name: v.name,description: v.description,price: v.price,imageUrl: v.imageUrl,count: v.count};
      });
   },
   ...
   var Variant = F6(function (a,b,c,d,e,f) {    return {id: a,name: b,description: c,price: d,imageUrl: e,count: f};});
   var addCountToVariant = function (variantWithoutCount) {
      return A6(Variant,
      ...
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "Show": var _p3 = _p2._0;
           if (_p3.ctor === "Ok") {
                 var _p4 = _p3._0;
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{showed: true,name: _p4.name,min: _p4.min,variants: A2($List.map,addCountToVariant,_p4.variants)})
                        ,_1: $Effects.none};
              } else {
